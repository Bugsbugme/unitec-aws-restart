...
echo -e "\n[Installing ZShell...]\n"
sudo yum install zsh -q -y && echo -e "\n${GREEN}[Installed ZShell]${NC}\n"
curl -s https://raw.githubusercontent.com/Bugsbugme/unitec-aws-restart/main/aws_init/zsh/default/.zshrc > $HOME && chmod +r $HOME/.zshrc

# This is changing the default shell to zsh.
echo -e "\n[Changing default Shell to ZShell...]\n"
sudo yum install util-linux-user -q -y
sudo chsh -s /usr/bin/zsh
sudo chsh -s /usr/bin/zsh $USER
exec zsh -l
echo -e "\n[Default Shell changed to $SHELL...]\n"

curl -s https://raw.githubusercontent.com/Bugsbugme/unitec-aws-restart/main/aws_init/scripts/install.sh > $HOME/aws_init && chmod +x $HOME/aws_init/install.sh
./install.sh && exec zsh -l
...
echo -e "\n[Installing Cowsay...]\n"
sudo yum install cowsay -q -y && echo -e "${GREEN}Installed Cowsay${NC}" | cowsay
echo
...
for package in util-linux-user zsh git gcc jq automake bison libevent-devel ncurses-devel docker
do
...
# echo
# curl -s https://raw.githubusercontent.com/Bugsbugme/unitec-aws-restart/main/install_zsh.sh | zsh && echo -e "\n${GREEN}[Installed ZShell]${NC}\n"
