...
echo "curl -s https://raw.githubusercontent.com/Bugsbugme/unitec-aws-restart/main/aws_vm_initscript.sh | sh && sudo usermod -a -G docker ec2-user && newgrp docker && exec zsh -l && sudo systemctl start docker.service"
echo
echo "Connecting..."
echo
