...
echo
sudo amazon-linux-extras install epel && echo -e "${GREEN}[Installed epel]${NC}\n"
...
do
        ...
        echo
        sudo yum install -y $package && echo -e "${GREEN}[Installed ${package}]${NC}\n"
done

# This is installing ohmyzsh.
echo Installing ohmyzsh... | cowsay
sh -c "$(curl -fsSL https://raw.githubusercontent.com/ohmyzsh/ohmyzsh/master/tools/install.sh)" && echo -e "${GREEN}[Installed ohmyzsh]${NC}\n"
...
curl https://raw.githubusercontent.com/Bugsbugme/unitec-aws-restart/main/data/.zshrc > $HOME/.zshrc && echo -e "${GREEN}[Retreived zshrc config]${NC}\n"
...
curl https://raw.githubusercontent.com/ChesterYue/ohmyzsh-theme-passion/master/passion.zsh-theme > $ZSH_CUSTOM/themes/passion.zsh-theme && echo -e "${GREEN}[Retreived ohmyzsh theme]${NC}\n"

# This is installing the zsh-autosuggestions plugin.
echo Installing zsh-autosuggestions... | cowsay
git clone https://github.com/zsh-users/zsh-autosuggestions $ZSH_CUSTOM/plugins/zsh-autosuggestions && echo -e "${GREEN}[Installed zsh-autosuggestions]${NC}\n"
...
sudo pip3 install tldr && echo -e "${GREEN}[Installed tldr]${NC}\n"
...
broot --install
echo -e "${GREEN}[Installed broot]${NC}\n"
...
echo -e "${GREEN}[Installed ohmytmux]${NC}\n"
