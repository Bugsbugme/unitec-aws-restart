...
git clone https://github.com/ChesterYue/ohmyzsh-theme-passion/blob/master/passion.zsh-theme > ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/themes/passion.zsh-theme && echo Retrieved ohmyzsh theme file | cowsay
